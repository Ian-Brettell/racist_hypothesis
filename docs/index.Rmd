...
snp_count_plot = list("PRE-CLUMP" = raw_counts,
  ...
  ggplot() +
    geom_col(aes(TRAIT, log10(N), fill = TRAIT)) +
    scale_fill_manual(values = pal_all) +
    theme_cowplot() +
    theme(axis.text.x = element_blank(),
          axis.title.x = element_blank(),
          axis.ticks.x = element_blank()) +
    ylab(expression(log[10]("number of loci"))) +
...
ggsave(here::here("docs/plots", clump_params, paste(clump_params, "_20220314_snp_counts.png", sep = "")),
       plot = snp_count_plot,
       device = "png",
       width = width,
       height = height,
...
ggsave(here::here("docs/plots", clump_params, paste(clump_params, "_20220314_snp_counts.svg", sep = "")),
       plot = snp_count_plot,
       device = "svg",
       width = width,
       height = height,
...
ggsave(here::here("docs/plots", clump_params, paste(clump_params, "_20220314_snp_counts.pdf", sep = "")),
       snp_count_plot,
       device = "pdf",
       width = width,
       height = height,
...
# Make versions for thesis

ggsave(here::here("docs/plots", clump_params, paste(clump_params, "_20220314_ecdf_all_faceted_with_controls_d_rank_long.pdf", sep = "")),
       plot = ecdf_plot_face_w_controls_d_rank, 
       device = "pdf",
       width = 38,
       height = 28,
...
ggsave(here::here("docs/plots", clump_params, paste(clump_params, "_20220314_ecdf_all_faceted_with_controls_d_rank_long.png", sep = "")),
       plot = ecdf_plot_face_w_controls_d_rank, 
       device = "png",
       width = 38,
       height = 28,
